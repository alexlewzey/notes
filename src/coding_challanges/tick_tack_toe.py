class Grid:
    ...
    def show_grid(self):
        ...
        print("-----")
        print(
            f"{self.g['middle-left']}|{self.g['middle-center']}|{self.g['middle-right']}"
        )
        print("-----")
        print(
            f"{self.g['bottom-left']}|{self.g['bottom-center']}|{self.g['bottom-right']}"
        )
        print("-----")
...
def winning_conditions(grid, player):
    if (
        grid.g["top-left"] == grid.g["top-center"] == grid.g["top-right"]
        and grid.g["top-left"] != " "
    ):
        winning_screen(player)
    elif (
        grid.g["middle-left"] == grid.g["middle-center"] == grid.g["middle-right"]
        and grid.g["middle-left"] != " "
    ):
        winning_screen(player)
    elif (
        grid.g["bottom-left"] == grid.g["bottom-center"] == grid.g["bottom-right"]
        and grid.g["bottom-left"] != " "
    ):
        winning_screen(player)

    elif (
        grid.g["top-left"] == grid.g["middle-left"] == grid.g["bottom-left"]
        and grid.g["top-left"] != " "
    ):
        winning_screen(player)
    elif (
        grid.g["top-center"] == grid.g["middle-center"] == grid.g["bottom-center"]
        and grid.g["top-center"] != " "
    ):
        winning_screen(player)
    elif (
        grid.g["top-right"] == grid.g["middle-right"] == grid.g["bottom-right"]
        and grid.g["top-right"] != " "
    ):
        winning_screen(player)

    elif (
        grid.g["top-left"] == grid.g["middle-center"] == grid.g["bottom-right"]
        and grid.g["top-left"] != " "
    ):
        winning_screen(player)
    elif (
        grid.g["top-right"] == grid.g["middle-center"] == grid.g["bottom-left"]
        and grid.g["top-right"] != " "
    ):
        winning_screen(player)
