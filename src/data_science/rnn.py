"""Using rnns to predict of a sin wave, in forecasting you need to include enough data
...
def forecasting_training_batches(sequence, train_size: int) -> list:
    """Split a sequence of data into a collection of training sequences with
    corresponding next point prediction label."""
    data: list = []
